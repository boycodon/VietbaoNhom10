...
@SuppressLint("NewApi")
public class NDKHCNActivity extends Activity {
	// khai bao
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// luu ngon ngu vao dât
				...
				if (check.equals("tiengviet")) {
					getActionBar().setTitle("KH-CN");
				} else {
					getActionBar().setTitle("Science and Technology");
				}
		...
		adapter2 = new SimpleAdapter(NDKHCNActivity.this, array,R.layout.custom_tinnong, from, to);
		...
		// doc theme
				...
				if (check.equals("bandem")) {
					...
					NDKHCNActivity.this.setTheme(android.R.style.Theme_DeviceDefault);
				} else {
	...
	public void redDataofTable() {
		...
		array.clear();
		arrLink.clear();
		Cursor c = database.query("tbKHCN", null, null, null, null, null, null);
		c.moveToFirst();
		while (c.isAfterLast() == false) {
