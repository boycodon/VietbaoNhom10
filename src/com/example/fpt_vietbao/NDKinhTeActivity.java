...
@SuppressLint("NewApi")
public class NDKinhTeActivity extends Activity {
	// khai bao
...
protected void onCreate(Bundle savedInstanceState) {
	...
	adapter2 = new SimpleAdapter(NDKinhTeActivity.this,array,R.layout.custom_tinnong,from,to);
	...
	// doc theme
			...
			if (check.equals("bandem")) {
				...
				NDKinhTeActivity.this.setTheme(android.R.style.Theme_DeviceDefault);
			} else {
...
public void redDataofTable() {
	...
	array.clear();
	arrLink.clear();
	Cursor c = database.query("tbKinhTe", null, null, null, null, null, null);
	c.moveToFirst();
	while (c.isAfterLast() == false) {
