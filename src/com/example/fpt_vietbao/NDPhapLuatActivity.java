...
@SuppressLint("NewApi")
public class NDPhapLuatActivity extends Activity {
	// khai bao
...
protected void onCreate(Bundle savedInstanceState) {
	...
	adapter2 = new SimpleAdapter(NDPhapLuatActivity.this,array,R.layout.custom_tinnong,from,to);
	...
	// doc theme
			...
			if (check.equals("bandem")) {
				...
				NDPhapLuatActivity.this.setTheme(android.R.style.Theme_DeviceDefault);
			} else {
...
public void redDataofTable() {
	...
	array.clear();
	arrLink.clear();
	Cursor c = database.query("tbPhapLuat", null, null, null, null, null, null);
	c.moveToFirst();
	while (c.isAfterLast() == false) {
