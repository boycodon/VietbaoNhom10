...
@SuppressLint("NewApi")
public class NDTheGioiAnhActivity extends Activity {
	// khai bao
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (check.equals("tiengviet")) {
			getActionBar().setTitle("Thế Giới Ảnh");
		} else {
		...
		adapter2 = new SimpleAdapter(NDTheGioiAnhActivity.this, array,
		...
		// doc theme
				...
				if (check.equals("bandem")) {
					...
					NDTheGioiAnhActivity.this.setTheme(android.R.style.Theme_DeviceDefault);
				} else {
	...
	public void redDataofTable() {
		...
		array.clear();
		arrLink.clear();
		Cursor c = database.query("tbTheGioiAnh", null, null, null, null, null,
				null);
		c.moveToFirst();
		while (c.isAfterLast() == false) {
