...
@SuppressLint("NewApi")
public class NDBongDaActivity extends Activity {
	// khai bao
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// luu ngon ngu vao dÃ¢t
				...
				if (check.equals("tiengviet")) {
					getActionBar().setTitle("Bóng Đá");
				} else {
					getActionBar().setTitle("Soccer ball");
				}
		...
		adapter2 = new SimpleAdapter(NDBongDaActivity.this, array,R.layout.custom_tinnong, from, to);
		...
		// doc theme
				...
				if (check.equals("bandem")) {
					...
					NDBongDaActivity.this.setTheme(android.R.style.Theme_DeviceDefault);
				} else {
	...
	public void redDataofTable() {
		...
		array.clear();
		arrLink.clear();
		Cursor c = database.query("tbBongDa", null, null, null, null, null,
				null);
		c.moveToFirst();
		while (c.isAfterLast() == false) {
