...
@SuppressLint("NewApi")
public class NDTheGioi extends Activity {
	// khai bao
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (check.equals("tiengviet")) {
			...
			getActionBar().setTitle("The world");
		}
		...
		adapter2 = new SimpleAdapter(NDTheGioi.this, array,
		...
		// doc theme
				...
				if (check.equals("bandem")) {
					...
					NDTheGioi.this.setTheme(android.R.style.Theme_DeviceDefault);
				} else {
	...
	public void redDataofTable() {
		...
		array.clear();
		arrLink.clear();
		Cursor c = database.query("tbTheGioi", null, null, null, null, null,
				null);
		c.moveToFirst();
		while (c.isAfterLast() == false) {
