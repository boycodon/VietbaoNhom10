...
@SuppressLint("NewApi")
public class NDGiaoDucActivity extends Activity {
	// khai bao
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter2 = new SimpleAdapter(NDGiaoDucActivity.this, array,
		...
		if (check.equals("bandem")) {
			...
			NDGiaoDucActivity.this.setTheme(android.R.style.Theme_DeviceDefault);
		} else {
	...
	public void redDataofTable() {
		...
		array.clear();
		arrLink.clear();
		Cursor c = database.query("tbGiaoDuc", null, null, null, null, null,
				null);
		c.moveToFirst();
		while (c.isAfterLast() == false) {
