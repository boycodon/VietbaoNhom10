...
@SuppressLint("NewApi")
public class NDSucKhoeActivity extends Activity {
	// khai bao
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter2 = new SimpleAdapter(NDSucKhoeActivity.this, array,
		...
		// doc theme
				...
				if (check.equals("bandem")) {
					...
					NDSucKhoeActivity.this.setTheme(android.R.style.Theme_DeviceDefault);
				} else {
	...
	public void redDataofTable() {
		...
		array.clear();
		arrLink.clear();
		Cursor c = database.query("tbSucKhoe", null, null, null, null, null,
				null);
		c.moveToFirst();
		while (c.isAfterLast() == false) {
